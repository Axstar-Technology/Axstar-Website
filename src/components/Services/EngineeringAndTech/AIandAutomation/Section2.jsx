...
const Section2 = () => {
  return (
    <section className="w-full bg-[#000000] text-white py-16 px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="py-8 md:pr-8 md:border-r border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-mono text-teal-500 border border-teal-500/30 px-2 py-1 rounded">01</span>
              <FiSettings className="text-teal-400 text-lg" />
            </div>
            <h3 className="text-base font-bold mb-3 text-gray-100 uppercase tracking-wider">
          ...
          <div className="py-8 md:px-8 md:border-r border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-mono text-teal-500 border border-teal-500/30 px-2 py-1 rounded">02</span>
              <FiSearch className="text-teal-400 text-lg" />
            </div>
            <h3 className="text-base font-bold mb-3 text-gray-100 uppercase tracking-wider">
          ...
          <div className="py-8 md:pl-8">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-mono text-teal-500 border border-teal-500/30 px-2 py-1 rounded">03</span>
              <FiBarChart2 className="text-teal-400 text-lg" />
            </div>
            <h3 className="text-base font-bold mb-3 text-gray-100 uppercase tracking-wider">
